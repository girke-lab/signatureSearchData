meta <- data.frame(
  ...
  RDataPath = c("signatureSearchData/v0.1/cmap/assays.h5",
                "signatureSearchData/v0.1/cmap/se.rds",
                "signatureSearchData/v0.1/cmap_expr/assays.h5",
                "signatureSearchData/v0.1/cmap_expr/se.rds",
                "signatureSearchData/v0.1/lincs/assays.h5",
                "signatureSearchData/v0.1/lincs/se.rds",
                "signatureSearchData/v0.1/lincs_expr/assays.h5",
                "signatureSearchData/v0.1/lincs_expr/se.rds",
