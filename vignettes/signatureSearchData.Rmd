...
The GS-Qs could also be defined by users by either selecting 150 up and down genes
or defining cutoffs of Z-scores. The GS-Qs can be used for _CMAP_, _LINCS_ GESS
...
Defining GS-DBs. The LINCS Z-score reference database will be internally
...
The GS-Qs could also be defined by users by either selecting 150 up and down genes
or defining cutoffs of LFC and FDRs. The GS-Qs can be used for _CMAP_, _LINCS_ GESS
methods. The following codes show examples of defining DEGs used as query and
defining DEG sets used as reference database.
...
Defining GS-DBs. The CMAP2 reference database will be internally
converted to the gene sets database in forms of the 0, 1, -1 matrix when 
