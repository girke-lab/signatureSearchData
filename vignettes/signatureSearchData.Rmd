...
weighted average signature (Level 5).  <font color="blue">Difference between Level 4 and 5 unclear. Please improve.</font> For a more detailed description of the preprocessing methods used by
...
above. Say things once and clearly. Don't keep duplicating since it will be confusing. If
